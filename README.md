...
| 文件 | 給誰看 | 內容 |
| --- | --- | --- |
| [`操作手冊.md`](docs/操作手冊.md) | 使用者 | 上線前要設定什麼、一個案子從接到結每一步按哪裡、常見狀況怎麼處理 |
| [`功能介紹.md`](功能介紹.md) | 評估中的人 | 有哪些模組、業主端能做什麼、系統每天自動做什麼 |
| [`產業痛點對照.md`](docs/產業痛點對照.md) | 開發者 | 設計依據：這個行業在哪裡虧錢，系統用什麼機制擋 |

系統裡每一頁上方也都有「**? 操作說明**」，寫的是那一頁的步驟、名詞與注意事項。
...
npm run test:ui    # 前端冒煙：jsdom 把整個 SPA 跑一遍，逐頁渲染，67 項
